---
title: "Spatial patterns' comparison"
...
Spatial patterns' comparison can be done using the `lsp_compare()` function.
...
Comparison of spatial patterns for irregular local landscapes requires setting `window = ecoregions["id"]`.
