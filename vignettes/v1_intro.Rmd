...
It just requires reading the input data as a `stars.proxy` by adding `proxy = TRUE` to the `read_stars()` function:
...
2. [Spatial patterns' comparison](https://jakubnowosad.com/motif/articles/v4_compare.html)
